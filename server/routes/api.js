...
module.exports = function (app, express) {
  ...
  router.get(
    "/attendance/member/:memberId/latest",
    attendanceController.getLatestByMemberId
  );
  router.get(
    "/attendance/member/:memberId/:time",
    attendanceController.getCountByMemberIdAndTime
  );
  ...
  router.get(
    "/attendance/all/:yyyymmdd",
    attendanceController.getAllForYYYYMMDD
  );

  router.post("/trainingfee", trainingFeeController.create);
  router.get(
    "/trainingfee/member/:memberId",
    trainingFeeController.getByMemberId
  );
  ...
  router.get(
    "/insurancefee/member/:memberId",
    insuranceFeeController.getByMemberId
  );
